...
const allTracks = [
  // --- NY DRILL ---
  { id: 1, title: "Brooklyn Nights", genre: "NY Drill", duration: "2:45", price: "$29.99", src: "/audio/drill1.mp3" },
  { id: 2, title: "Ops Outside", genre: "NY Drill", duration: "3:10", price: "$29.99", src: "/audio/drill2.mp3" },
  { id: 3, title: "No Suburban", genre: "NY Drill", duration: "2:55", price: "$29.99", src: "/audio/drill3.mp3" },
  { id: 4, title: "Glacier", genre: "NY Drill", duration: "3:05", price: "$34.99", src: "/audio/drill4.mp3" },
  { id: 5, title: "Demon Time", genre: "NY Drill", duration: "2:30", price: "$29.99", src: "/audio/drill5.mp3" },

  // --- DARK TRAP ---
  { id: 6, title: "Nightmare", genre: "Dark Trap", duration: "3:20", price: "$24.99", src: "/audio/trap1.mp3" },
  { id: 7, title: "Shadow Realm", genre: "Dark Trap", duration: "2:50", price: "$24.99", src: "/audio/trap2.mp3" },
  { id: 8, title: "Graveyard Shift", genre: "Dark Trap", duration: "3:15", price: "$29.99", src: "/audio/trap3.mp3" },
  { id: 9, title: "Venom", genre: "Dark Trap", duration: "2:40", price: "$24.99", src: "/audio/trap4.mp3" },
  { id: 10, title: "Abyss", genre: "Dark Trap", duration: "3:30", price: "$29.99", src: "/audio/trap5.mp3" },

  // --- JERSEY CLUB ---
  { id: 11, title: "Club Luv", genre: "Jersey Club", duration: "2:15", price: "$19.99", src: "/audio/jersey1.mp3" },
  { id: 12, title: "Bounce Back", genre: "Jersey Club", duration: "2:10", price: "$19.99", src: "/audio/jersey2.mp3" },
  { id: 13, title: "Bed Squeak Anthem", genre: "Jersey Club", duration: "2:20", price: "$24.99", src: "/audio/jersey3.mp3" },
  { id: 14, title: "Fast Life", genre: "Jersey Club", duration: "2:05", price: "$19.99", src: "/audio/jersey4.mp3" },
  { id: 15, title: "Heartbeat", genre: "Jersey Club", duration: "2:30", price: "$24.99", src: "/audio/jersey5.mp3" },
];

const genres = ["NY Drill", "Dark Trap", "Jersey Club"];
